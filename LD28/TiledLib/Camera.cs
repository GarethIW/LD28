    ...
    public class Camera
    {
        ...
        public void Update(GameTime gameTime)
        {
           ...
           // Position.X = MathHelper.Clamp(Position.X, ClampRect.X, ClampRect.Width - Width);
            ...
            CameraMatrix = Matrix.CreateTranslation(-((int)Position.X), (-(int)Position.Y) + shakeOffset.Y, 0) * Matrix.CreateScale(1f) * Matrix.CreateRotationZ(-Rotation) *Matrix.CreateTranslation(Width / 2, 600f, 0);
